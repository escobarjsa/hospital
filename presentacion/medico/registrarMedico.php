...
<div class="container">
	<div class="row mt-4">
		...
		<div class="col-6">
			<div class="card">
				<div class="card-header bg-primary text-white">Registrar Medico</div>
				<div class="card-body">
					<?php
					if ($error == 0) {
					?>
					...
					<?php } ?>
					<form action=<?php echo "index.php?pid=" . base64_encode("presentacion/medico/registrarMedico.php") ?> method="post">
